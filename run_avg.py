...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='FedGPTime')
    ...
    parser.add_argument('--train_epochs', type=int, default=100, help='training epochs')#训练轮数
    ...
    # set logger
    args.checkpoint = 'checkpoint_{}_{}_{}_{}_{}'.format(args.lm_pretrain_model.lower(), args.lm_ft_type, args.training_list.split('/')[1].split('.')[0], args.lm_layer_num, args.max_backcast_len)
